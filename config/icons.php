...
return [
    ...
    */
    ...
    'actions' => [
        'view' => 'free/health-medical/rounded/outlined/eye',
        'edit' => 'free/education/rounded/outlined/pencil-1',
        'delete' => 'free/editing/rounded/outlined/trash-3',
        'duplicate' => 'pro/interface/rounded/outlined/copy-3',
        ...
        'segments' => 'free/design-tools/rounded/outlined/layout-9',
        'cues' => 'pro/health-medical/rounded/outlined/clipboard-check',
        'run-of-show' => 'pro/health-medical/rounded/outlined/clipboard-text',
        'versions' => 'free/interface/rounded/outlined/refresh-circle-1-clockwise',
        'make-admin' => 'pro/direction-navigation/rounded/outlined/user-map-locked',
        'remove-admin' => 'pro/direction-navigation/rounded/outlined/user-map-minus-circle',
        ...
        'deactivate' => 'pro/user/rounded/outlined/users-xmark',
    ],
    ...
    'ui' => [
        ...
        'send-comment' => 'pro/communication/rounded/outlined/comment-1-plus',
        'view-comment' => 'pro/communication/rounded/outlined/comment-1-dots',
