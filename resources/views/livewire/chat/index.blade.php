<div wire:poll.3s="refreshChat" class="flex bg-gray-50 dark:bg-gray-900" style="height: calc(100vh - 4rem);">
        ...
        <div class="flex-1 overflow-y-auto">
            @forelse($conversations as $conv)
                <button 
                    ...
                    class="w-full p-4 flex items-center gap-3 hover:bg-gray-50 dark:hover:bg-gray-700 border-b border-gray-100 dark:border-gray-700 text-left transition-colors {{ $activeConversationType === $conv['type'] && $activeConversationId == $conv['id'] ? 'bg-blue-50 dark:bg-blue-900/20' : '' }}"
                >
