<div>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-12">
        ...
        <div class="mb-6 flex justify-between items-center">
            ...
            <a href="{{ route('events.content.edit', ['eventId' => $event->id, 'contentId' => $content->id]) }}" 
               class="inline-flex items-center px-4 py-2 bg-blue-600 dark:bg-blue-500 hover:bg-blue-700 dark:hover:bg-blue-600 text-white font-medium rounded-lg transition-colors duration-150">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
                        ...
                        <div class="p-6">
                            ...
                            @if($content->file_type !== 'url')
                                <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                                    @if(in_array($content->file_type, ['plain_text', 'rich_text']))
                                        <button
                                            wire:click="download"
                                        ...
                                        >
                                            <x-action-icon action="download" class="mr-2" />
                                            Download File
                                        </button>
                                    @else
                                        <a
