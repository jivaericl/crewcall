<div>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-12">
        ...
        <div class="mb-6 flex justify-between items-center">
            <div>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Resource - {{ $event->name }}</h2>
            </div>
        </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <form wire:submit.prevent="save" class="p-6 space-y-6">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
                        <h3 class="font-semibold text-gray-900 dark:text-gray-100 mb-2">Current Resource</h3>
                    ...
                    <!-- Name -->
                    <div>
                        <flux:label for="name" required>Resource Name</flux:label>
                        <flux:input
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <flux:label for="file_type" required>Resource Type</flux:label>
                    ...
                    <div class="flex justify-end gap-3 pt-4">
                        <flux:button
                            href="{{ route('events.resources.index', $eventId) }}"
                            variant="ghost"
                        >
                            Cancel
                        </flux:button>
