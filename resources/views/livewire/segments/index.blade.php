                                        ...
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex justify-end gap-1">
                                                    <a href="{{ route('sessions.segments.show', [$sessionId, $segment->id]) }}" class="inline-flex items-center px-2 py-1 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded transition-colors" title="View">
                                                        <x-action-icon action="view" />
                                                    </a>
                                                    <flux:button href="{{ route('segments.cues.index', $segment->id) }}" variant="ghost" size="sm" title="Cues">
                                                        <x-action-icon action="cues" />
                                                    </flux:button>
