                                        ...
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex justify-end gap-1">
                                                    ...
                                                    <a href="{{ route('sessions.run-of-show', $session->id) }}" title="Run of Show" class="inline-flex items-center justify-center px-2 py-1 bg-blue-600 dark:bg-blue-600 border border-transparent rounded text-white dark:text-white hover:bg-blue-700 dark:hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
