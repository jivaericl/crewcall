                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4 flex-1">
                                                <div class="flex items-center gap-2">
                                                    <a href="{{ route('events.team-members.show', [$eventId, $travel->user_id]) }}" class="text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                                                        {{ $travel->user->name }}
                                                    </a>
                                                    <a href="{{ route('events.team-members.show', [$eventId, $travel->user_id]) }}" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" title="View team member details">
